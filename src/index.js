    ...
    getMovies().then((movies) => {
        ...
        movies.forEach(({title, rating, id, genre}) => {
            $('.movies').append(`
                ...
                <p>Rating: ${rating}</p>
                <p>Genre: ${genre}</p>
                <button id="editButton" class="btn btn-primary edit" data-toggle="collapse" data-target="#collapse" aria-expanded="false" aria-controls="collapseExample"value="${id}">Edit</button>
