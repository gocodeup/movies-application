...
getMovies().then((movies) => {
  ...
  movies.forEach(({title, rating, id}) => {
    $movies.append(`<li class="list-group-item"> id#${id}  ${title}  rating: ${rating}<button id="deleteMovie" class="btn btn-outline-danger btn-sm float-right delete">X</button></li>`);
